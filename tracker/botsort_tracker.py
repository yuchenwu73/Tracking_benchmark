...
# BoT-SORT跟踪器实现 - 结合ReID和全局运动补偿的多目标跟踪算法
#
# BoT-SORT (Bootstrapping Object Tracking with SORT) 是ByteTrack的增强版本
# 主要改进：
# 1. 集成ReID (Re-identification) 特征进行外观匹配
# 2. 添加全局运动补偿(GMC)处理相机运动
# 3. 使用特征平滑技术提高跟踪稳定性
# 4. 支持多种全局运动补偿方法（ORB, SIFT, ECC, 稀疏光流）

from collections import deque

import numpy as np

from .base_tracker import TrackState
from .bytetrack_tracker import BYTETracker, STrack
from .utils import detection_matching as matching
from .utils.global_motion_compensation import GMC
